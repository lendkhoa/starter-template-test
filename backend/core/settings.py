...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-core-secret-key')
...
N8N_WEBHOOKS = {
    "generate-report": os.environ.get("N8N_WEBHOOK_REPORT", "https://n8n.example.com/webhook/report"),
    "sync-contacts": os.environ.get("N8N_WEBHOOK_SYNC", "https://n8n.example.com/webhook/sync"),
}
